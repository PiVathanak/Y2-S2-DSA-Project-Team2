...
string CSVManager::trim(const string& str) {
...
void CSVManager::loadStudents(LinkedList& list) {
...
void CSVManager::saveStudents(LinkedList& list) {
...
void CSVManager::loadAdmins(LinkedList& list) {
...
void CSVManager::loadTeachers(LinkedList& list) {
...
void CSVManager::loadCourses(LinkedList& list) {
...
void CSVManager::saveCourses(LinkedList& list) {
    ofstream file("DataBase/Courses.csv");
    file << "course_id,course_name,teacher_id,credits\n";
    ListNode* curr = list.head;
    while (curr) {
        Course* c = (Course*)curr->data;
        file << c->course_id << "," << c->course_name << "," << c->teacher_id << "," << c->credits << "\n";
        curr = curr->next;
    }
    file.close();
}

void CSVManager::loadEnrollments(LinkedList& list) {
...
void CSVManager::saveEnrollments(LinkedList& list) {
...
void CSVManager::loadPendingEnrollments(Queue& q) {
...
void CSVManager::savePendingEnrollments(Queue& q) {
